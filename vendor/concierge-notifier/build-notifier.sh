...
ICON_SRC=../../assets-concierge-icon.png
APP=ConciergeNotifier.app
CONTENTS="$APP/Contents"
MACOS="$CONTENTS/MacOS"
RESOURCES="$CONTENTS/Resources"
ICONSET=ConciergeIcon.iconset
ICNS=ConciergeIcon.icns
IDENTITY="${CODESIGN_ID:-Developer ID Application: Peter Steinberger (Y5PE65HELJ)}"
ZIP="/tmp/ConciergeNotifierNotarize.zip"
...
cleanup() {
  rm -f "$ZIP" /tmp/concierge-notifier-api-key.p8
}
trap cleanup EXIT
...
mv "$ICNS" "$RESOURCES/ConciergeIcon.icns"
rm -rf "$ICONSET"
...
<dict>
  ...
  <string>com.concierge.notifier</string>
  <key>CFBundleName</key>
  <string>ConciergeNotifier</string>
  <key>CFBundleDisplayName</key>
  <string>Concierge Notifier</string>
  <key>CFBundleExecutable</key>
  <string>ConciergeNotifier</string>
  <key>CFBundleIconFile</key>
  <string>ConciergeIcon</string>
...
swiftc -target arm64-apple-macos13 -o "$MACOS/ConciergeNotifier" ConciergeNotifier.swift -framework Foundation -framework UserNotifications
